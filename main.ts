...
var HOST :string = "192.168.2.112";
var PORT :number = 12004;
...
function sendResponse(frame:Buffer, sock:net.Socket) {
    buff_req[12] = frame[12];
    buff_req[13] = frame[13];
    sock.write(buff_req);
}

function logFrame(frame:Buffer) {
...
net.createServer(function(sock) {
    var buffer:Buffer = Buffer.allocUnsafe(0);
